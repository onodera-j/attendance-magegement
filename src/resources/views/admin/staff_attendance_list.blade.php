...
<div class="content">
    ...
    <div class="select-month">
        <div class="last-month">
            <a class="link-date" href="{{ route('admin.staff.attendance.list', ['year' => $viewDate['prevYear'], 'month' => $viewDate['prevMonth'], 'id' => $user['id']]) }}">前月</a>
        </div>
        <div class="this-month">
            <img class="icon-calender" src="{{ asset("img/calender.svg") }}"><span class="date">{{$viewDate['yearMonth']}}</span>
        </div>
        <div class="next-month">
            <a class="link-date" href="{{ route('admin.staff.attendance.list', ['year' => $viewDate['nextYear'], 'month' => $viewDate['nextMonth'], 'id' => $user['id']]) }}">翌月</a>
        </div>
    </div>
