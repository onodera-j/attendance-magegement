                    ...
                    <table class="table-request">
                        ...
                        @foreach ($requestDatas as $requestData)
                            <tr class="table-row">
                                ...
                                <td class="table-data">{{ $requestData->user->name }}</td>
                                ...
                                <td class="table-data td-detail">
                                    @if ($user === 'admin')
                                        <a class="link-detail" href="/stamp_correction/approve/{{ $requestData['id'] }}">詳細</a>
                                    @else
                                        <a class="link-detail" href="/attendance/{{ $requestData['attendance_id'] }}">詳細</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <table class="table-approve">
                        ...
                        @foreach ($approveDatas as $approveData)
                            <tr class="table-row">
                                ...
                                <td class="table-data">{{ $approveData->user->name }}</td>
                                ...
                                <td class="table-data td-detail">
                                    @if ($user === 'admin')
                                        <a class="link-detail" href="/stamp_correction/approve/{{ $approveData['id'] }}">詳細</a>
                                    @else
                                        <a class="link-detail" href="/attendance/{{ $approveData['attendance_id'] }}">詳細</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
