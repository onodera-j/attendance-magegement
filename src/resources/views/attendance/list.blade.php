    ...
    <div class="content">
        ...
        <div class="select-month">
            <div class="last-month">
                <a class="link-date"
                    href="{{ route('attendance.list', ['year' => $viewDate['prevYear'], 'month' => $viewDate['prevMonth']]) }}">前月</a>
            </div>
            ...
            <div class="next-month">
                <a class="link-date"
                    href="{{ route('attendance.list', ['year' => $viewDate['nextYear'], 'month' => $viewDate['nextMonth']]) }}">翌月</a>
            </div>
        </div>
