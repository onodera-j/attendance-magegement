            ...
            <div class="attendance-detail">
                ...
                <div class="detail-row">
                    ...
                    <div class="row-content content-record text-datetime">
                        {{ $requestData->work_start_datetime->format('Y年') }}</div>
                ...
                <div class="detail-row">
                    ...
                    <div class="row-content content-decorate">～</div>
                    <div class="row-content content-record text-datetime">
                        {{ $requestData->work_end_datetime->format('H:i') }}</div>
                ...
                @foreach ($requestRestDatas as $index => $requestRestData)
                    <div class="detail-row">
                        ...
                        <input type="hidden" name="requestRestId[{{ $index }}]"
                            value="{{ $requestRestData->id }}">
                    </div>
                @endforeach
                <div class="detail-row">
